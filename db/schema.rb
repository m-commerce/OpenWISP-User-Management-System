...
ActiveRecord::Schema.define(:version => 20110604111002) do
  ...
  create_table "access_points", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "last_configuration_retrieve_ip"
    t.boolean  "configuration_outdated",         :default => true
  ...
  create_table "radio_templates", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "driver",                   :default => "madwifi-ng", :null => false
    t.integer  "driver_slot",              :default => 0,            :null => false
  end
